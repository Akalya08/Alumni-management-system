...
if($uploadOk ==1){
    ...
    if($image_url){
        ...
        $sql="UPDATE tblevents set event_name=:event_name,date_time=:date_time,place=:place,
        who=:who
        ". $qry." 
        ...
        <div class="col-md-12">
          ...
          <?php } ?>
            <div class="tile-body">
              ...
              $sql ="SELECT * from tblevents where id=:adminid ";
              $query= $dbh -> prepare($sql);
              ...
              { ?>
                ...
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" name="event_name" id="event_name" type="text" placeholder="Enter your Title Name" value="<?=$result->event_name?>" required>
                </div>
                 ...
                 <div class="form-group col-md-6">
                  ...
                  <input class="form-control" type="text" name="place" name="place" placeholder="Enter Place" value="<?=$result->place?>" required>
                </div>

                 <div class="form-group col-md-6">
                  <label class="control-label">Chief Guest</label>
                  <input class="form-control" type="text" name="who" id="who" placeholder="Enter your Who Contect" value="<?=$result->who?>" required>
                </div>

                <div class="form-group col-md-6">
                  <label class="control-label">Date Time</label>
                  <input type="datetime-local"  class="form-control" name="date_time" id="date_time" placeholder="Enter your Who Contect" value="<?=$result->date_time?>" required>
                </div>

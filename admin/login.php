...
if(isset($_POST['submit'])) {
  ...
  if($email != "" && $password != "") {
    try {
      $query = "select id, name, email, mobile, password, create_date,user_role from tbladmin where email=:email and password=:password";
